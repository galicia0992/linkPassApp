...
export type ComponentProps<GenericComponentStyles, Variants, P, ComCon> = SxStyleProps<GenericComponentStyles, Variants, P, 'animationComponentGluestack' extends keyof P ? P['animationComponentGluestack'] extends true ? Plugins : [] : []> & {
    states?: {
        [K in IState]?: boolean;
    };
...
export type UtilityProps<GenericComponentStyles, GenericComponentProps> = Omit<TokenizedRNStyleProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps> & Omit<AliasesProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps>;
/********************* UTILITY TYPE *****************************************/
